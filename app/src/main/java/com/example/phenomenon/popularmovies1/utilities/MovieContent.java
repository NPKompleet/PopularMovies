...
/**
 * Created by PHENOMENON on 3/31/2017.
 */

public class MovieContent {
    public static final ArrayList<MyMovie> MOVIES = new ArrayList<MyMovie>();


    public static final HashMap<Long, MyMovie> MOVIE_MAP = new HashMap<Long, MyMovie>();


    public static class MyMovie implements Parcelable{
